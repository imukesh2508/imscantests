...
//Select file type as Universal Filing
WebUI.selectOptionByIndex(findTestObject('Object Repository/DocumentType/FileType'), 2)

//enter the document Type Name
WebUI.sendKeys(findTestObject('Object Repository/DocumentType/Enter_DocumentName'), findTestData('ImScanDataSource').getValue(1, 4))
