...
//Select 1st Report from the list_return
WebUI.click(findTestObject('Object Repository/Reports/Select1stReportFromList'))

//Click on the Export CSV option_return
WebUI.click(findTestObject('Object Repository/Reports/ExportAsCSVButton'))
