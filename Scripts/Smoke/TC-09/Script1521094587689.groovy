...
//Enter the code
WebUI.setText(findTestObject('Object Repository/Create_a_New_Dept/CreateDeptPopup/PopUpforDept/input_Code'), findTestData('ImScanDataSource').getValue(5, 1))

//Enter the name of Dept
WebUI.setText(findTestObject('Object Repository/Create_a_New_Dept/CreateDeptPopup/PopUpforDept/input_Name'), findTestData('ImScanDataSource').getValue(6, 1))

//Click On save
WebUI.click(findTestObject('Object Repository/Create_a_New_Dept/ClickOnSavePopup'))

//to check error Message has been displayed
WebUI.focus(findTestObject('Object Repository/Create_a_New_Dept/AlreadyExistingDeptCode-DeptName'))

try {
    String Errormsg = WebUI.getText(findTestObject('Object Repository/Create_a_New_Dept/AlreadyExistingDeptCode-DeptName'))
