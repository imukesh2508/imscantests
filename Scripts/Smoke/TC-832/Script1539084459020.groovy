...
WebUI.click(findTestObject('Object Repository/Reports/Audit_Trail'))

//click on generate Reports
WebUI.click(findTestObject('Object Repository/Reports/GenerateReports(AuditTrial)'))

//verify data is generated or not
WebUI.verifyElementPresent(findTestObject('Object Repository/Reports/GeneratedDatafromTable(auditTrail)'), 15)