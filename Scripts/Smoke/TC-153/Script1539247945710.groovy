...
//Click on Logout 
WebUI.waitForElementVisible(findTestObject('Object Repository/Home/LogoutLink'), 10)
WebUI.click(findTestObject('Object Repository/Home/LogoutLink'))

Thread.sleep(1000)

WebUI.waitForElementVisible(findTestObject('Object Repository/Home/IMSCANLogo'),10)
