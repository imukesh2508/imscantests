...
WebUI.click(findTestObject('Object Repository/Reports/LogReports'))

//click on generate reports
WebUI.click(findTestObject('Object Repository/Reports/GenerateReports(LogReports)'))

//Verify data generated Or not
WebUI.verifyElementPresent(findTestObject('Object Repository/Reports/GenerateddataFromTable(logReports)'),10)