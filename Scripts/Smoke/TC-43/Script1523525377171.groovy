...
WebUI.scrollToElement(findTestObject('Object Repository/DocumentType/ClickOnDocumentType'), 2)
...
//focus to the PopUp
WebUI.focus(findTestObject('Object Repository/DocumentType/DocumentSetUpPopUp'))
//focus on the OK button div
WebUI.focus(findTestObject('Object Repository/DocumentType/OKbuttonDiv')) 

WebUI.click(findTestObject('Object Repository/DocumentType/OKbutton'))
