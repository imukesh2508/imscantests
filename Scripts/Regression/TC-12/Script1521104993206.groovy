...
//click on deptname
WebUI.focus(findTestObject('Object Repository/Create_a_New_Dept/PopUpForEditDept/ClickOnDeptName(Edit)'))
//Change the Department Name to already Existing dept name
WebUI.setText(findTestObject('Object Repository/Create_a_New_Dept/PopUpForEditDept/ClickOnDeptName(Edit)'), '2')
//click on Save
WebUI.click(findTestObject('Object Repository/Create_a_New_Dept/PopUpForEditDept/ClickOnSaveOnPopUp'))

//error Message should be displayed
WebUI.focus(findTestObject('Object Repository/Create_a_New_Dept/ErrorMessageForEditAlreadyExistingDeptNam'))
try {
	String errMsg=WebUI.getText(findTestObject('Object Repository/Create_a_New_Dept/ErrorMessageForEditAlreadyExistingDeptNam'))
	println (errMsg)
} 
catch (Exception e) {
