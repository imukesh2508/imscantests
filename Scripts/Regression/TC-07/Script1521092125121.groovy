...
//Enter the code
WebUI.setText(findTestObject('Object Repository/Create_a_New_Dept/CreateDeptPopup/PopUpforDept/input_Code'), '92')
//Enter the name of Dept
WebUI.setText(findTestObject('Object Repository/Create_a_New_Dept/CreateDeptPopup/PopUpforDept/input_Name'), 'Law1')
//Click On save
WebUI.click(findTestObject('Object Repository/Create_a_New_Dept/ClickOnSavePopup'))
//to check error Message has been displayed
WebUI.focus(findTestObject('Object Repository/Create_a_New_Dept/ErrorMsgForAlreadyExistingName'))
try {
String msg=WebUI.getText(findTestObject('Object Repository/Create_a_New_Dept/ErrorMsgForAlreadyExistingName'))
println (msg)
