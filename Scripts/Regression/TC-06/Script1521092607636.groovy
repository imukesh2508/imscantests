...
//Enter the code
WebUI.setText(findTestObject('Object Repository/Create_a_New_Dept/CreateDeptPopup/PopUpforDept/input_Code'), '98')

//NOT entering the dept Name


//Click On save
WebUI.click(findTestObject('Object Repository/Create_a_New_Dept/ClickOnSavePopup'))
//to check error Message has been displayed
WebUI.focus(findTestObject('Object Repository/Create_a_New_Dept/ErrorMsgForBlankDeptName'))
try {
String msg=WebUI.getText(findTestObject('Object Repository/Create_a_New_Dept/ErrorMsgForBlankDeptName'))
println (msg)
